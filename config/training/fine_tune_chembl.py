...
out_dir = 'out-models'
init_ckpt_path = 'out-very-big-molecules-selfies-2/ckpt_zink_M.pt'  # Path al checkpoint preentrenado
...
dataset = 'very_big_molecules_selfies_2/chembl'  # Name of your dataset directory
